...
def main(request, response):
    ...
    headers.append((b"X-Request-Method", request.method))
    headers.append((b"X-Request-Query", request.url_parts.query if request.url_parts.query else b"NO"))
